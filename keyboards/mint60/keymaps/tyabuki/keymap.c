 ...
 * |------+------+------+------+------+------++------+------+------+------+------+------+------+------|
 * |LShift|   Z  |   X  |   C  |   V  |   B  ||   N  |   M  |   ,  |   .  |   /  |RShift|  Up  |RShift|
 * |-----------------------------------------++-------------------------------------------------------|
 * | Fn1 | LCtrl | LAlt  |  LCmd |   Space   ||    Space       | RCmd   | Fn1    | Left | Down |Right |
 * `--------------------------------------------------------------------------------------------------'
 */
  [_Q_MAC] = LAYOUT( \
    ...
    MO(_FN_MAC), KC_LCTL, KC_LALT, KC_LCMD, KC_SPC,              KC_SPC,       KC_RCMD, MO(_FN_MAC),       KC_LEFT, KC_DOWN, KC_RGHT \
  ),
/*
 * Fn_MAC
 * ,--------------------------------------------------------------------------------------------------.
 ...
 * |------+------+------+------+------+------++------+------+------+------+------+------+------+------|
 * |      |BriDwn|BriUp |      |      |BLInc ||BLDec | Prev | Play | Next | Mute |VolDwn|VolUp |      |
 * |------+------+------+------+------+------++------+------+------+------+------+------+------+------|
 * | Caps |      |      |      |      |      ||      |      |      |      |      |      |             |
 * |------+------+------+------+------+------++------+------+------+------+------+------+------+------|
 * | ---- |      |      |      |      | WIN  || MAC  |      |      |      |      |      | PgUp | ---- |
 ...
 */
  [_FN_MAC] = LAYOUT( \
    ...
    XXXXXXX, KC_BRMD, KC_BRMU, XXXXXXX, XXXXXXX, BL_INC,          BL_DEC,     KC_MRWD, KC_MPLY, KC_MFFD, KC__MUTE, KC__VOLDOWN, KC__VOLUP, XXXXXXX, \
    KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,     XXXXXXX,   \
    KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_Q_WIN),      TG(_Q_MAC), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,     KC_PGUP,   KC_TRNS, \
 ...
 */
  [_Q_WIN] = LAYOUT( \
    ...
    KC_LCTL,      KC_A,    KC_S,    KC_D,    KC_F,   KC_G,        KC_H,   KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_ENT,  \
    KC_LSFT,      KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,        KC_N,   KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP,   KC_RSFT, \
    MO(_FN_WIN),  KC_LCTL, KC_LWIN, KC_LALT, KC_SPC,              KC_SPC,       KC_RALT, MO(_FN_WIN),     KC_LEFT, KC_DOWN, KC_RGHT \
  ),
/*
 * Fn_WIN
 * ,--------------------------------------------------------------------------------------------------.
 ...
 */
  [_FN_WIN] = LAYOUT( \
    ...
    KC_CAPS, XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX,         XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_Q_WIN),      TG(_Q_MAC), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, KC_TRNS, \
    XXXXXXX, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                  KC_TRNS,             KC_TRNS, XXXXXXX,          KC_HOME, KC_PGDN, KC_END \
  ),
/*
